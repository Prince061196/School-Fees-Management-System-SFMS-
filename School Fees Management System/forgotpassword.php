...
$sql = "select * from user where id= '".$_SESSION['rainbow_uid']."' ";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update user set  password = '".$newpassword."' WHERE id = '".$_SESSION['rainbow_uid']."'";
$r = $conn->query($sql);
echo '<script type="text/javascript">window.location="forgotpassword.php?act=1"; </script>';
}else
{
	...
	<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Forgot Password</h1>
               ...
               <div class="panel panel-success">
						...
						<label class="col-sm-4 control-label" for="Email">User Name</label>
								<div class="col-sm-5">
