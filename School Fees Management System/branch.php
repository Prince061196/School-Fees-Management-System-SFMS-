...
$website = mysqli_real_escape_string($conn,$_POST['website']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (branch,address,detail, email_address, contact_number, website) VALUES ('$branch','$address','$detail','$email_address', '$contact_number', '$website')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  branch  SET  branch  = '$branch', address  = '$address', detail  = '$detail', email_address= '$email_address', contact_number = '$contact_number', website='$website'  WHERE  id  = '$id'");
...
<head>
    ...
    <title style="text-align: left">Fees Management System</title>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Confirm"> Contact Number</label>
								<div class="col-sm-10">
                         <textarea class="form-control" name="contact_number" id="contact_number"><?php echo                                    $contact_number;?></textarea >
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Confirm">Email Address </label>
								<div class="col-sm-10">
									    <textarea class="form-control" name="email_address" id="email_address">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Confirm"> Website</label>
								<div class="col-sm-10">
									    <textarea class="form-control" name="website" id="website">
									        <?php echo $website;?>
                                        </textarea >
								</div>
							</div>
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
											...
											<td>'.$r['detail'].'</td>
											<td>
											<a href="branch.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs"><span>Edit</span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="branch.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span>Delete</span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
