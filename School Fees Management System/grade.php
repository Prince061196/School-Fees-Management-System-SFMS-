...
$conn->query("DELETE FROM grade WHERE `grade`.`id` ='".$_GET['id']."'");
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Grade/Standard Levels  
						<?php
                             ...
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr>
                                            ...
                                            <td>'.$r['detail'].'</td>
											<td>
											<a href="grade.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs" style="border-radius:60px;"><span>Edit</span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="grade.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs" style="border-radius:60px;"><span>Delete</span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
